    ...
    return [
      {
        ...
        - 내용
        내용의 정확한지, 내용 사이의 연관이 있는지, 주제의 명료하고 타당한지, 세부 내용 전개는 적절한지, 중복되는 내용은 없는가, A~D로 나타내고 예시도 언급합니다.

        - 구성
        글 구조의 적절한지, 문단 구조의 적절한지, 구성의 통일성이 있는지, 구성의 일관되어 있는지 A~D로 나타내고 예시도 언급합니다.

        - 표현
        어휘 사용의 적절한지, 문장 구조가 적절한지, 효과적 표현이 사용되었는지, 개성적 표현이 사용되었는지, 지나치게 긴 문장이나 자주 사용되는 단어는 없는지, A~D로 나타내고 예시도 언급합니다.

        - 문법
        주술관계가 잘 이루어져 있는지, 문법적으로 틀린 부분이 없는지, 맞춤법은 적절한지 A~D로 나타내고 예시도 언급합니다.
